...
move /y "%userprofile%\Downloads\Adobe-Debloater-main\Adobe-Debloater-main\chrome_elf_bak.dll" "%APPDATA%\Spotify\chrome_elf_bak.dll" > Nul 2>&1
move /y "%userprofile%\Downloads\Adobe-Debloater-main\Adobe-Debloater-main\chrome_elf.dll" "%APPDATA%\Spotify\chrome_elf.dll" > Nul 2>&1 > Nul 2>&1
goto last
